...
public class OCA_Questions_ErdemDenizli {
	...
	public static void main(String[] args) {
		...
		// 5-10 questions about methods, class members and their properties (statics,
		// non-statics)
		// 15-20 questions about OOP concept such as inheritance, interface, abstract
		// classes, constructors, overloading and overriding, polymorphism
...
//		
//		System.out.println(Arrays.toString(array4));	   // for see the answer
//		
//		System.out.println("********************************");
//		
//		int variable = 9;
...
//
//	}
//	public static void getSum(short x, short y) {
//		System.out.println("int sum is " + (x + y));
//	}
//	public static void getSum(int x, int y) {
//		System.out.println("int sum is " + (x + y));
//	}
//	public static void getSum(Integer x, Integer y) {
//		System.out.println("Integer sum is " + (x + y));
//	}
//	public static void getSum(long x, long y) {
